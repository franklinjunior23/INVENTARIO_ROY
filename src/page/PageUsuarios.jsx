...
function PageUsuarios() {
  ...
  const UserJson = [
    ...
    {
      name: "alondra Vega Luna",
      id: 230022,
      gmail: "alondritamanza@gmail.com",
    },
    {
      name: "jessica Casandra",
      id: 2838542,
      gmail: "jessicaclemente@gmail.com",
    },
  ];
  const filtr = () => {
    ...
    <>
      <section className="flex justify-end mb-6">
        <aside className="">
          ...
          <input
            type="text"
            className="py-2 px-4 border focus:outline-none border-black rounded-md"
